...
public class MainJFrameWindow {
	...
	private void initialize() {
		...
		JLabel label = new JLabel("Syn.arithmos forologoumenwn");
		...
		final JLabel totalLoadedTaxpayersJLabel = new JLabel("0");
		...
		JButton openTaxpayerLoadDataJDialog = new JButton("fortwsh dedomenwn forologoumenwn");
		...
		final JButton showLoadedTaxpayersDataButton = new JButton("Emfanhsh listas forologoumenwn");
		...
		openTaxpayerLoadDataJDialog.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				afmInfoFilesFolderChooser.setDialogTitle("epelekse fakelo me <AfM>_INFO arxeia");
