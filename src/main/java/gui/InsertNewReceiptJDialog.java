...
public class InsertNewReceiptJDialog extends JDialog {
	...
	public InsertNewReceiptJDialog(final int taxpayerID) {
		...
		final JTextField receiptIdTextField = new JTextField();
		...
		final JTextField companyTextField = new JTextField();
		...
		final JTextField countryTextField = new JTextField();
		...
		final JComboBox kindComboBox = new JComboBox();
