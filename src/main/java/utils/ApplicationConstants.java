...
public class ApplicationConstants {
    ...
    public static final int [] INCOME_LIMITS_SINGLE = new int[] { 24680, 81080, 90000, 152540 };
    public static final int [] INCOME_LIMITS_HEAD_OF_HOUSEHOLD = new int[] { 30390, 90000, 122110, 203390 };
